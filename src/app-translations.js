...
const PROFILE_TEXT = {
  nl: {
    ownerBadge: "🏡 BnB Eigenaar", buddyBadge: "🎒 Buddy",
    propertyLabel: "Pand", roomsLabel: "Kamers", priceLabel: "Prijs/nacht", availableLabel: "Beschikbaar",
    destinationLabel: "Bestemming", monthsLabel: "Maanden", peopleLabel: "Personen",
    aboutLabel: "Over {name}", lockMore: "🔒 Login voor meer",
    interestsLabel: "Interesses",
    propertyPhotosLabel: "Foto's van het pand", travelPhotosLabel: "Reisfoto's",
    backBtn: "← Terug", editProfileBtn: "✏️ Profiel bewerken", messageBtn: "💬 Bericht", loginToChatBtn: "🔒 Login om te chatten",
    messagePlaceholder: "Bericht aan {name}…", onlineStatus: "● Online",
    matchesEmptyTitle: "Nog geen berichten", matchesEmptySubtitle: "Bekijk profielen en start een gesprek.", nowLabel: "nu",
    reviewsTitle: "Reviews", noReviewsYet: "Nog geen reviews.",
    reviewSubmitted: "✓ Je review is ingediend en wordt beoordeeld.",
    writeReview: "Schrijf een review", reviewPlaceholder: "Vertel over je ervaring…",
    sending: "Versturen…", submitReview: "Review versturen",
  },
  en: {
    ownerBadge: "🏡 BnB Owner", buddyBadge: "🎒 Buddy",
    propertyLabel: "Property", roomsLabel: "Rooms", priceLabel: "Price/night", availableLabel: "Available",
    destinationLabel: "Destination", monthsLabel: "Months", peopleLabel: "People",
    aboutLabel: "About {name}", lockMore: "🔒 Log in for more",
    interestsLabel: "Interests",
    propertyPhotosLabel: "Property photos", travelPhotosLabel: "Travel photos",
    backBtn: "← Back", editProfileBtn: "✏️ Edit profile", messageBtn: "💬 Message", loginToChatBtn: "🔒 Log in to chat",
    messagePlaceholder: "Message {name}…", onlineStatus: "● Online",
    matchesEmptyTitle: "No messages yet", matchesEmptySubtitle: "Browse profiles and start a conversation.", nowLabel: "now",
    reviewsTitle: "Reviews", noReviewsYet: "No reviews yet.",
    reviewSubmitted: "✓ Your review has been submitted and is being reviewed.",
    writeReview: "Write a review", reviewPlaceholder: "Tell us about your experience…",
    sending: "Sending…", submitReview: "Submit review",
  },
  de: {
    ownerBadge: "🏡 BnB-Eigentümer", buddyBadge: "🎒 Buddy",
    propertyLabel: "Unterkunft", roomsLabel: "Zimmer", priceLabel: "Preis/Nacht", availableLabel: "Verfügbar",
    destinationLabel: "Reiseziel", monthsLabel: "Monate", peopleLabel: "Personen",
    aboutLabel: "Über {name}", lockMore: "🔒 Anmelden für mehr",
    interestsLabel: "Interessen",
    propertyPhotosLabel: "Fotos der Unterkunft", travelPhotosLabel: "Reisefotos",
    backBtn: "← Zurück", editProfileBtn: "✏️ Profil bearbeiten", messageBtn: "💬 Nachricht", loginToChatBtn: "🔒 Anmelden zum Chatten",
    messagePlaceholder: "Nachricht an {name}…", onlineStatus: "● Online",
    matchesEmptyTitle: "Noch keine Nachrichten", matchesEmptySubtitle: "Sieh dir Profile an und starte ein Gespräch.", nowLabel: "jetzt",
    reviewsTitle: "Bewertungen", noReviewsYet: "Noch keine Bewertungen.",
    reviewSubmitted: "✓ Deine Bewertung wurde eingereicht und wird geprüft.",
    writeReview: "Bewertung schreiben", reviewPlaceholder: "Erzähl von deiner Erfahrung…",
    sending: "Wird gesendet…", submitReview: "Bewertung senden",
  },
  fr: {
    ownerBadge: "🏡 Propriétaire BnB", buddyBadge: "🎒 Buddy",
    propertyLabel: "Logement", roomsLabel: "Chambres", priceLabel: "Prix/nuit", availableLabel: "Disponible",
    destinationLabel: "Destination", monthsLabel: "Mois", peopleLabel: "Personnes",
    aboutLabel: "À propos de {name}", lockMore: "🔒 Connecte-toi pour en voir plus",
    interestsLabel: "Centres d'intérêt",
    propertyPhotosLabel: "Photos du logement", travelPhotosLabel: "Photos de voyage",
    backBtn: "← Retour", editProfileBtn: "✏️ Modifier le profil", messageBtn: "💬 Message", loginToChatBtn: "🔒 Connecte-toi pour discuter",
    messagePlaceholder: "Message à {name}…", onlineStatus: "● En ligne",
    matchesEmptyTitle: "Pas encore de messages", matchesEmptySubtitle: "Parcours les profils et lance une conversation.", nowLabel: "maintenant",
    reviewsTitle: "Avis", noReviewsYet: "Pas encore d'avis.",
    reviewSubmitted: "✓ Ton avis a été envoyé et est en cours de vérification.",
    writeReview: "Écrire un avis", reviewPlaceholder: "Raconte ton expérience…",
    sending: "Envoi…", submitReview: "Envoyer l'avis",
  },
};
